//
// NCR SCSI Tool - ROM module main code
// Based on ncr_dmatest ROM module structure
//
           ...
           __reg("a6") struct ExecBase* SysBase)
{
    ...
    if (DOSBase) {
        AddSegment("ncr_scsi", MKBADDR(&trampoline), CMD_INTERNAL);
