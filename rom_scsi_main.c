//
// NCR SCSI Test Tool - ROM module main code
// Based on ncr_dmatest structure
//
...
extern uint8_t ncr_scsitest_cli;
extern int end;
           ...
           __reg("a6") struct ExecBase* SysBase)
{
    ...
    if (DOSBase) {
        AddSegment("ncr_scsitest", MKBADDR(&trampoline), CMD_INTERNAL);
